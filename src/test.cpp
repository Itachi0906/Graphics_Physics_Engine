...
//
//    Grics::World world(1, 1);
//    Grics::RigidBody p1, p2, p3;
...
//    p1.setLinearDamping(0.99);
//    p2.setLinearDamping(0.99);
//    p3.setLinearDamping(0.99);
//    p1.setAngularDamping(0.99);
//    p2.setAngularDamping(0.99);
//    p3.setAngularDamping(0.99);
//    p1.setMass(1.0f);
//    p2.setMass(1.0f);
//    p3.setMass(1.0f);
//
...
//
//    p1.setVelocity(Grics::Vector3(5.0f, 0.0f, 0.0f));
...
//            world.startFrame();
//
//            world.runPhysics(fixedTimeStep);
//
